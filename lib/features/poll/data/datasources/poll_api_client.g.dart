...
class _PollApiClient implements PollApiClient {
  _PollApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PollResponse> createPoll(CreatePollDto pollDto) async {
    ...
    _data.addAll(pollDto.toJson());
    final _options = _setStreamType<PollResponse>(
  ...
  Future<List<PollResponse>> getPollsByEvent(int eventId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PollResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<PollResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => PollResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<List<PollStatsResponse>> getPollStatsByEvent(int eventId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PollStatsResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/polls/events/${eventId}/stats',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<PollStatsResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                PollStatsResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<PollResponse> updatePoll(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updatePollDto.toJson());
    final _options = _setStreamType<PollResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
